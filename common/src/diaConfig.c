...
osXmlData_t diaConfig_xmlData[DIA_XML_MAX_DATA_NAME_NUM] = {
    ...
    {DIA_XML_CONFIG_LOCAL_IP,   {"DIA_CONFIG_LOCAL_IP", sizeof("DIA_CONFIG_LOCAL_IP")-1},     OS_XML_DATA_TYPE_XS_STRING, false},
    {DIA_XML_MAX_HOST_IP_NUM,   {"DIA_MAX_HOST_IP_NUM", sizeof("DIA_MAX_HOST_IP_NUM")-1},     OS_XML_DATA_TYPE_XS_SHORT,  false},
    {DIA_XML_CONFIG_PEER_PORT,  {"DIA_CONFIG_PEER_PORT", sizeof("DIA_CONFIG_PEER_PORT")-1},   OS_XML_DATA_TYPE_XS_SHORT, false},
    {DIA_XML_MAX_SAME_AVP_NUM,  {"DIA_MAX_SAME_AVP_NUM", sizeof("DIA_MAX_SAME_AVP_NUM")-1},   OS_XML_DATA_TYPE_XS_SHORT, false},
    {DIA_XML_FIRMWARE_REVISION, {"DIA_FIRMWARE_REVISION", sizeof("DIA_FIRMWARE_REVISION")-1}, OS_XML_DATA_TYPE_XS_SHORT, false},
    {DIA_XML_MAX_INTERFACE_NUM, {"DIA_MAX_INTERFACE_NUM", sizeof("DIA_MAX_INTERFACE_NUM")-1}, OS_XML_DATA_TYPE_XS_SHORT, false},
    {DIA_XML_CONFIG_LISTEN_PORT,        	{"DIA_CONFIG_LISTEN_PORT", sizeof("DIA_CONFIG_LISTEN_PORT")-1},       OS_XML_DATA_TYPE_XS_SHORT, false},
    {DIA_XML_CONN_TIMER_WATCHDOG,       	{"DIA_CONN_TIMER_WATCHDOG", sizeof("DIA_CONN_TIMER_WATCHDOG")-1},     OS_XML_DATA_TYPE_XS_LONG, false},
    {DIA_XML_CONN_TIMER_WAIT_CONN,      	{"DIA_CONN_TIMER_WAIT_CONN", sizeof("DIA_CONN_TIMER_WAIT_CONN")-1},   OS_XML_DATA_TYPE_XS_LONG, false},
    {DIA_XML_CONN_TIMER_RETRY_CONN,     	{"DIA_CONN_TIMER_RETRY_CONN", sizeof("DIA_CONN_TIMER_RETRY_CONN")-1}, OS_XML_DATA_TYPE_XS_LONG, false},
    {DIA_XML_REQ_WAIT_RESP_DEFAULT_TIME, 	{"DIA_REQ_WAIT_RESP_DEFAULT_TIME", sizeof("DIA_REQ_WAIT_RESP_DEFAULT_TIME")-1}, OS_XML_DATA_TYPE_XS_LONG, false},
    {DIA_XML_CONFIG_MAX_AVP_INSIDE_GRP_AVP,     {"DIA_CONFIG_MAX_AVP_INSIDE_GRP_AVP", sizeof("DIA_CONFIG_MAX_AVP_INSIDE_GRP_AVP")-1},         OS_XML_DATA_TYPE_XS_SHORT, false},
    {DIA_XML_CONN_TIMER_TRANSMIT_WAIT_TIME,     {"DIA_CONN_TIMER_TRANSMIT_WAIT_TIME", sizeof("DIA_CONN_TIMER_TRANSMIT_WAIT_TIME")-1},         OS_XML_DATA_TYPE_XS_LONG, false},
    {DIA_XML_CX_MAX_SERVER_CAPABILITY_ITEM,     {"DIA_CX_MAX_SERVER_CAPABILITY_ITEM", sizeof("DIA_CX_MAX_SERVER_CAPABILITY_ITEM")-1},         OS_XML_DATA_TYPE_XS_SHORT, false},
    {DIA_XML_CONFIG_TRANSPORT_TCP_BUFFER_SIZE,  {"DIA_CONFIG_TRANSPORT_TCP_BUFFER_SIZE", sizeof("DIA_CONFIG_TRANSPORT_TCP_BUFFER_SIZE")-1},   OS_XML_DATA_TYPE_XS_SHORT, false}};
...
{
	osXmlDataCallbackInfo_t cbInfo={true, true, false, NULL, NULL, diaConfig_xmlData, DIA_XML_MAX_DATA_NAME_NUM};
